...
BOOST_AUTO_TEST_CASE( inCollisionTests )
{
    ...
    /* Collision with contact */
    {
    Circle c1(Point(0.0,0.0),0.5);
    Circle c2(Point(0.0,1.0),0.5);
    Vector2d d1(0.0,1.0);
    Vector2d d2(0.0,-1.0);
...
BOOST_AUTO_TEST_CASE( collisionPoints )
{
    ...
    BOOST_CHECK_CLOSE(collision.x(), 1.5, 0.0001 );
    BOOST_CHECK_CLOSE(collision.y(), 1.0, 0.0001 );
    BOOST_CHECK_CLOSE(bg::distance(collision,inter),0.5,0.0001);
    BOOST_CHECK_CLOSE(inter.x(), 2.0, 0.0001 );
    BOOST_CHECK_CLOSE(inter.y(), 1.0, 0.0001 );
    }
}
...
BOOST_AUTO_TEST_CASE( newDirection )
{
    ...
    Vector2d r = c1.newDirection(d1,c2,d2);
    Vector2d r2 = c2.newDirection(d2,c1,d1);


    BOOST_CHECK_CLOSE(r.x(), -1.0, 0.0001 );
    BOOST_CHECK_CLOSE(r.y(), 0.0, 0.0001 );
    BOOST_CHECK_CLOSE(r2.x(), 1.0, 0.0001 );
    BOOST_CHECK_CLOSE(r2.y(), 0.0, 0.0001 );
    }

    {
    Circle c1(Point(0.0,0.0),0.5);
    Circle c2(Point(0.0,3.0),0.5);
    Vector2d d1(0.0,1.0);
    Vector2d d2(0.0,-1.0);
    ...
    BOOST_CHECK_CLOSE(r.x(), 0.0, 0.0001 );
    BOOST_CHECK_CLOSE(r.y(), -1.0, 0.0001 );
    BOOST_CHECK_CLOSE(r2.x(), 0.0, 0.0001 );
    BOOST_CHECK_CLOSE(r2.y(), 1.0, 0.0001 );
    }

    {
    Circle c1(Point(0.0,0.0),0.5);
    Circle c2(Point(2.0,0.0),0.5);
    Vector2d d1(0.5,0.5);
    Vector2d d2(-0.5,0.5);
    ...
    BOOST_CHECK_CLOSE(r.x(), -0.5, 0.0001 );
    BOOST_CHECK_CLOSE(r.y(), 0.5, 0.0001 );
    BOOST_CHECK_CLOSE(r2.x(), 0.5, 0.0001 );
    BOOST_CHECK_CLOSE(r2.y(), 0.5, 0.0001 );
    }
}
